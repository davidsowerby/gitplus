...
public interface BuildPropertiesLoader {
    String BINTRAY_TOKEN = "bintrayToken";
    String TAGGER_NAME = "taggerName";
    String TAGGER_EMAIL = "taggerEmail";
    String GITHUB_TOKEN_RESTRICTED = "githubApiTokenRestricted";
    String GITHUB_TOKEN_CREATE_REPO = "gitHubApiTokenCreateRepo";
    String GITHUB_TOKEN_DELETE_REPO = "gitHubApiTokenDeleteRepo";
